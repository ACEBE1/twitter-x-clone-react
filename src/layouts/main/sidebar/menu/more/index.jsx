...
export default function More() {
  return (
    <Popover className="relative">
      ...
      <PopoverPanel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-lg-white rounded-xl overflow-hidden">
        ...
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a] ">
          ...
          <div className="pr-4 text-xl font-bold">İşler</div>
        </button>
        ...
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[#eff3f41a] ">
          ...
          <div className="pr-4 text-xl font-bold">Sohbet Odanı Oluştur</div>
        </button>
